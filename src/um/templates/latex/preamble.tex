...
%# Font families
%#\usepackage[sfdefault]{roboto}  % default font
...
\usepackage{lastpage}
%# \lfoot{\footerstyle \thepage \hspace{1pt} von \pageref{LastPage}}  %# footer left
\rfoot{CC-BY, \href{https://www.unkenmathe.de}{unkenmathe.de}}  %# footer right
